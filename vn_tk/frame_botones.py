...
class FrameBotones(tk.Frame):
    def __init__(self, parent, bg='#303030', bgh='#272822', bgh_x='#F92672', bga='green', *args, **kw):
        super(FrameBotones, self).__init__(master=parent, bg=bg, *args, **kw)
        self.bg = bg
        self.bgh = bgh
        self.bga = bga
        self.bgh_x = bgh_x
    ...
    def _widget_FrameBotones(self):
        d = {'bgh':self.bgh, 'activebackground':self.bga, 'bg':self.bg}
